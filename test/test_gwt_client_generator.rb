...
class TestGwtClientGenerator < Test::Unit::TestCase
  ...
  def test_generator_without_options
    ...
    %w(clients/gwt/UI-compile clients/gwt/UI-shell clients/gwt/lib/gwt-rest.jar clients/gwt/lib/gwt-cloudkit.jar clients/gwt/lib/gwittir-core-0.4.4.jar clients/gwt/src/ui/UI.gwt.xml clients/gwt/src/ui/client/AppEntryPoint.java).each do |f|
